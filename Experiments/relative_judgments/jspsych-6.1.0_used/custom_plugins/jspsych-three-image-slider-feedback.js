...
jsPsych.plugins['three-image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    var response = {
      ...
      display_element.querySelector('#jspsych-three-image-slider-response-response').disabled = true;
     ...
     document.getElementById('output').innerHTML = '<br> You entered: ' + val + '<br> The right answer is: ' + trial.feedback
